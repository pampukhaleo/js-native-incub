...
test("sum of first N numbers", () => {
    expect(sumFirstNumbers2(0)).toBe(0)
    expect(sumFirstNumbers(4)).toBe(10)
    expect(sumFirstNumbers(10)).toBe(55)
    expect(sumFirstNumbers2(10)).toBe(55)
    expect(sumFirstNumbers2(10)).toBe(55)
    expect(sumFirstNumbers3(4)).toBe(10)
    expect(sumFirstNumbers3(10)).toBe(55)
})
